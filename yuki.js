...
› Create By yukicanpedia
› Base Ori HW MODS

🌷 KALAU MAU RENAME TARO CREDITS GUA : ${botname}
recode : mizu*/ // recode yukicanpedia
//=================================================//
require('./yukican')
require('./lib/menunya')
...
const { ngazap } = require('./yukicapedia/virtex/ngazap')
const { buttonkal } = require('./yukicapedia/virtex/buttonkal')
const { cttl } = require('./yukicapedia/virtex/cttl')
const { tizi } = require('./yukicapedia/virtex/tizi')
const { weg } = require('./yukicapedia/virtex/weg')
const ffstalk = require('./scrape/ffstalk')
const { virtex7 } = require('./yukicapedia/virtex/virtex7')
...
const db_user = JSON.parse(fs.readFileSync('./yukicapedia/user.json'))
//=================================================/
...
const { remini } = require('./yukicapedia/remini.js')
const thumbnail = fs.readFileSync ('./yukicapedia/image/alamak.jpg')
const thumb = fs.readFileSync ('./yukicapedia/image/alamak.jpg')
const kalimage = fs.readFileSync ('./yukicapedia/image/alamak.jpg')
...
const banned = JSON.parse(fs.readFileSync('./yukicapedia/dbnye/banned.json'))
const { getRegisteredRandomId, addRegisteredUser, createSerial, checkRegisteredUser } = require('./database/register.js')
const isRegistered = checkRegisteredUser(m.sender)
virgam = fs.readFileSync(`./yukicapedia/image/shiqi.jpeg`)
//=================================================//
module.exports = mizu = async (mizu, m, chatUpdate, setting, store) => {
 try {
...
const botNumber = await mizu.decodeJid(mizu.user.id)
const isAutoSticker = m.isGroup ? autosticker.includes(from) : false
const isCreator = [botNumber, ...owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
const sender = m.isGroup ? (m.key.participant ? m.key.participant : m.participant) : m.key.remoteJid
const groupMetadata = m.isGroup ? await mizu.groupMetadata(from).catch(e => {}) : ''
...
const prem = JSON.parse(fs.readFileSync('./yukicapedia/dbnye/premium.json'))
	...
	"interactiveMessage": {
						...
						"nativeFlowMessage": {
							"buttons": [
								{
									"name": "review_and_pay",
									"buttonParamsJson": "{\"currency\":\"IDR\",\"external_payment_configurations\":[{\"uri\":\"\",\"type\":\"payment_instruction\",\"payment_instruction\":\"hey ini test\"}],\"payment_configuration\":\"\",\"payment_type\":\"\",\"total_amount\":{\"value\":2500000,\"offset\":100},\"reference_id\":\"4MX98934S0D\",\"type\":\"physical-goods\",\"order\":{\"status\":\"pending\",\"description\":\"\",\"subtotal\":{\"value\":2500000,\"offset\":100},\"items\":[{\"retailer_id\":\"6285731947500\",\"product_id\":\"685731947500\",\"name\":\"ShiqiZey\",\"amount\":{\"value\":2500000,\"offset\":100},\"quantity\":1}]}}"
								}
							]
			}
}}}
...
const reply = (teks) => {
return mizu.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `Aku Sayang ${botname}🥰`,"body": `Selamat ${ucapanWaktu} kak ${pushname}`, mediaType: 1, renderLargerThumbnail: true, "previewType": "PHOTO","thumbnailUrl": `${global.gambar}`,"thumbnail": thumb,"sourceUrl": `${global.gcori}`}}}, { quoted:m})} 

const errorReply = (teks) => {
        return mizu.sendMessage(from, {text: teks,  contextInfo: {
    ...
    pageCount: 10909143,	
     ...
     async function replyMsg(teks) {
            ...
            return mizu.sendMessage(m.chat, prince, {
                quoted: ftroli
            });
        };
const vidReply = (teks) => {
 return mizu.sendMessage(from, { video: vidmenu, gifPlayback: true, caption: `${text}`, contextInfo:{ externalAdReply: {
title:`shiqi`,
body: `${jam}`,
thumbnail: thum,
...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thum, surface: 200, message: botname, orderTitle: ownername, sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		...
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":botname, "h": gcori,'seconds': '359996400', 'gifPlayback': 'true', 'caption': ownername, 'jpegThumbnail': good}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": gcori, "caption": `${pushname}`, 'jpegThumbnail': thum}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":botname, "h": gcori,'seconds': '359996400', 'caption': `${pushname}`, 'jpegThumbnail': good}}}
		const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: gcori,jpegThumbnail: thum}}}
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Kafka By ShiqiZey`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;ShiqiZey,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3c485ff201d9337be14ef.jpg' }}}}
...
.on('finish', async () => {
await mizu.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
.on('finish', async () => {
await mizu.sendMessage(from, { video: fs.readFileSync(mp4File), gifPlayback: false }, { quoted: m })
...
let { key } = await mizu.sendMessage(from, {text: 'ʟᴏᴀᴅɪɴɢ...'})//Awalan

for (let i = 0; i < ShiqiZey.length; i++) {
/*await delay(10)*/
await mizu.sendMessage(from, {text: ShiqiZey[i], edit: key });//setelah nya
}
}
if (autodelete) {
mizu.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: true,
...
/*let reactionMessage = {
                ...
                await sleep(1500)
                mizu.sendMessage(m.chat, reactionMessage)*/
//=================================================//
...
await mizu.setStatus(`I'm Kafka - MD🤖 | ${runtime(process.uptime())} ⏰ | Status : ${mizu.mode ? "Public Mode" : "Self Mode"} | 1.3k Users`)
...
if (m.message) {
mizu.sendPresenceUpdate(jd, from)
...
let gclink = (`https://chat.whatsapp.com/`+await mizu.groupInviteCode(m.chat))
let isLinkThisGc = new RegExp(gclink, 'i')
let isgclink = isLinkThisGc.test(m.text)
if (isgclink) return mizu.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAnda tidak akan ditendang oleh bot karena yang Anda kirim adalah link ke grup ini`})
if (isAdmins) return mizu.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAdmin sudah mengirimkan link, admin bebas memposting link apapun`})
if (isCreator) return mizu.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\nOwner telah mengirim link, owner bebas memposting link apa pun`})
await mizu.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: false,
...
userJid: mizu.user.id,
quoted : m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, mizu.user.id)
...
mizu.ev.emit('messages.upsert', msg)
}
//=================================================//
...
async function sendGeekzMessage(chatId, message, options = {}){
    ...
    return await mizu.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}

const sendapk = (teks) => {
mizu.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
m.reply('*Rusak Om !! Yang Bener Contoh : Yoapk ShiqiZey*')
}
...
//=================================================//
const sendzip = (teks) => {
mizu.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted:m})
m.reply('*Rusak Om !! Yang Bener Contoh : Yozip ShiqiZey*')
}
...
//=================================================//
const senddocu = (teks) => {
mizu.sendMessage(from, { document: teks, mimetype: 'application/pdf'}, {quoted:m})
m.reply('*Rusak Om !! Yang Bener Contoh : Yopdf ShiqiZey*')
}
...
const sendvn = (teks) => {
mizu.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, {quoted:m})
}
...
try {
ppuser = await mizu.profilePictureUrl(m.sender, 'image')
} catch (err) {
...
mizu.sendText(from, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+from].pesan = mesg }).catch(_ => _)
...
if (budy.toLowerCase() == jawaban) {
   mizu.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Lagu`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 mizu.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Gambar`}, {quoted:m})
...
if (budy.toLowerCase() == jawaban) {
 mizu.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Kata`}, {quoted:m})  
...
if (budy.toLowerCase() == jawaban) {
 mizu.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Lontong 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Lontong`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 mizu.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Kalimat`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 mizu.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Lirik`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 mizu.sendMessage(m.chat, { image: ppnyauser, caption: `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? Silahkan Ketik Tebak Tebakan`}, {quoted:m}) 
...
if (room.x !== room.o) await mizu.sendText(room.x, str, m, { mentions: parseMention(str) } )
await mizu.sendText(room.o, str, m, { mentions: parseMention(str) } )
if (isTie || isWin) {
...
mizu.sendTextWithMentions(from, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
mizu.sendText(from, `Suit telah dikirimkan ke chat
...
if (!roof.pilih) mizu.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
if (!roof.pilih2) mizu.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) mizu.sendText(from, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
mizu.sendTextWithMentions(from, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
if (!roof.pilih2) mizu.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
m.reply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) mizu.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
...
mizu.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
switch(command) {
        case 'daftar':
                ...
                if (!m.isGroup) {
                    ...
                    mizu.sendMessage(m.chat, {image: thum, caption: mzd}, {quoted: m})
...
sᴇʟᴀᴍᴀᴛ ${ucapanWaktu} 😊
${menu}`;
     mizu.sendMessage(from, { video: vidmenu, gifPlayback: true, caption: menuu, contextInfo:{ externalAdReply: {
title: botname,
body: `JAN SPAM GW🙃`,
thumbnail: thum,
mediaType: 1,
...
mizu.sendMessage(from, { video: { url: data.dl_url }, caption: data.title })
})
}
break
...
mizu.sendMessage(m.chat, {image:{url: bufas}, caption: hg }, {quoted:m})
}
break*/
case "simple":
       case "simpel":
...
┆ ☂︎ 𝙹𝚊𝚖: ${time} WIB
┗––––––––––✦
${simpel}`; mizu.sendMessage(from, { video: vidmenu, gifPlayback: true, caption: taasimpel, contextInfo:{ externalAdReply: {
title: botname,
body: `JAN SPAM GW🙃`,
thumbnail: thum,
mediaType: 1,
...
${allmenu}`; mizu.sendMessage(from, { video: vidmenu, gifPlayback: true, caption: mizuall, contextInfo:{ externalAdReply: {
title: botname,
body: `JAN SPAM GW🙃`,
thumbnail: thum,
mediaType: 1,
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./yukicapedia/image/alamak.jpg`),
"sourceUrl": `${mizu}`}}},
{ quoted: m})        
            }
            break
...
mizu.sendMessage(m.chat, { react: { text: `👌`, key: m.key }})
try {
let txt = await getBuffer(`https://skizo.tech/api/txt2img?text=${text}&apikey=rnsid_bot`)
await mizu.sendMessage(m.chat, {image: txt, caption: `Done Sayang`},{quoted: m})
mizu.sendMessage(m.chat, { react: { text: `✅`, key: m.key }})
     } catch (e) {
...
${ownermenu} `
mizu.sendMessage(from, { text: text12, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: fkontak })
}
break
case "tqto": 
 const owned = `${owner}@s.whatsapp.net`
...
await mizu.sendMessage(m.chat, {audio: fs.readFileSync('./audio.mp3'),mimetype: 'audio/mpeg',ptt: true}, {quoted:m})
...
*_Social Media_*
*IG : ▣https://www.instagram.com/genkaku._*
*YT : ▣https://youtube.com/@YukiCnPedia*
*GC : ▣${global.gcori}*
...
case 'infomenu':
//if (!isRegistered) return replyMsg('Kamu belum daftar!\nSilahkan daftar dengan cara *.daftar nama.umur!*')
   if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
await loading()
...
var lokasinya = location[Math.floor(Math.random() * location.length)]
 if (lokasinya === 'Hutan') {
 var image = './yukicapedia/image/rimba.jpg'
} else
 if (lokasinya === 'Hutan Amazon') {
 var image ='./yukicapedia/image/amazon.jpg'
} else
 if (lokasinya === 'Hutan Tropis') {
 var image = './yukicapedia/image/tropis.jpg'
} else
 if (lokasinya === 'Padang Rumput') {
 var image = './yukicapedia/image/padang_rumput.jpg'
} else
 if (lokasinya === 'Hutan Afrika') {
 var image = './yukicapedia/image/afrika.jpg'
} else
 if (lokasinya === 'Pegunungan') {
var image = './yukicapedia/image/pegunungan.jpg'
}
 setTimeout( () => {
...
mizu.sendMessage(m.chat, { image: { url: image }, caption: teksehmazeh }, { quoted: m })
}, 5000)
setTimeout( () => {
...
mizu.sendMessage(m.chat, { image: { url: './yukicapedia/image/tambang.jpg' }, caption: caption }, { quoted: m })
}, 7000)
setTimeout( () => {
...
mizu.sendMessage(m.chat, { react: { text: `⏱️`, key: m.key }})
const media = await mizu.downloadAndSaveMediaMessage(quoted)
const anu = await TelegraPH(media)
mizu.sendMessage(m.chat, { image: { url: `https://skizo.tech/api/toanime?url=${anu}&apikey=${setting.XznKey}` }, caption: 'Done Jadi Anime Ayangg >///<'}, { quoted: m})
mizu.sendMessage(m.chat, { react: { text: `✅`, key: m.key }})
}
break
//=================================================/
...
const qrcode = require('qrcode')
    if (!text) return errorReply(`Penggunaan Salah Harusnya ${prefix+command} ShiqiZey`)
const qyuer = await qrcode.toDataURL(text, { scale: 8 })
let data = new Buffer.from(qyuer.replace('data:image/png;base64,', ''), 'base64')
mizu.sendMessage(from, { image: data, caption: `Sukses Kak` }, { quoted: kalgans })
}
break
case "detectqr": {
try {
mee = await mizu.downloadAndSaveMediaMessage(quoted)
...
let media = await mizu.downloadAndSaveMediaMessage(quoted)
...
let metaDATA = await mizu.groupMetadata(idgc).catch((e) => reply(e))
...
setTimeout(function() {
mizu.sendMessage(getDATA[i], { text: pesan });
count--;
sentCount++;
if (count === 0) {
...
for (let geek of mem) {
await sleep(3000)
mizu.sendMessage(geek, {text: `${teksnye}`}, {quoted:m})
}
...
let ceknya = await mizu.onWhatsApp(prrkek)
if (ceknya.length == 0) return reply(`Enter a valid and registered number on WhatsApp!!!`)
prem.push(prrkek)
fs.writeFileSync('./yukicapedia/dbnye/premium.json', JSON.stringify(prem))
...
teks = '*Premium List*\n\n'
for (let mizu of prem) {
teks += `- ${mizu}\n`
}
teks += `\n*Total : ${prem.length}*`
mizu.sendMessage(m.chat, { text: teks.trim() }, 'extendedTextMessage', { quoted: fkontak , contextInfo: { "mentionedJid": prem } })
break
//=================================================//
case 'pengguna':  {
if (!isCreator) return errorReply(mess.owner)
...
let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
    ...
    mizu.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => reply('error om :<'))
break
    case 'hd': case 'remini': {
			...
			mizu.sendMessage(m.chat, { image: proses, caption: 'success'}, { quoted: m})
			}
			break
...
//=================================================//
      case 'paptt':
            ...
            if (q == 'foto') {
                mizu.sendMessage(m.chat, { image: { url: sagne }, caption: 'Mana Tahan🥵'}, { quoted: fkontak })
            } else if (q == 'video') {
                mizu.sendMessage(m.chat, { video: { url: sange }, caption: 'Mana Tahan🥵'}, { quoted: fkontak })
            }
        break
...
//=================================================//
  /* case 'daftar':
                ...
                if (!m.isGroup) {
                    addRegisteredUser(m.sender, namaUser, umurUser, serialUser)
                    mizu.sendMessage(m.chat, {image: thum, caption: mzd}, {quoted: fkontak})
...
case 'owner':{
 ...
 mizu.sendContact(from, global.owner, fkontak)
    
}
break
case 'wa': case 'whatsapp':{
await loading()
 mizu.sendContact(from, global.owner, m)
}
break
case "bot": 
 reply(`*Hi ${pushname}*
...
await mizu.sendMessage(m.chat, {audio: fs.readFileSync('./audio.mp3'),mimetype: 'audio/mpeg',ptt: true}, {quoted:ftroli})
break
...
mizu.sendMessage(m.chat, { caption: `Here you go!`, video: { url: data.watermark }}, {quoted:m})
})
}
break
...
reply(`Tunggu sebentar ya kakak:>`)
require('./lib/tiktok').Tiktok(q).then( data => {
mizu.sendMessage(m.chat, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})
}
break
        //anime
 ...
 waifudd = await axios.get(`https://nekos.life/api/v2/img/waifu`)       
            await mizu.sendMessage(m.chat, { image: { url:waifudd.data.url} , caption: mess.success}, { quoted:m }).catch(err => {
                    return('Error!')
                })
                }
break
        case 'loli': {
reply(mess.wait)
mizu.sendMessage(m.chat, { image: { url: `https://api.akuari.my.id/randomimganime/loli`}, caption: `𝗗𝗼𝗻𝗲 𝗸𝗮𝗸`})
}
break
//=================================================
...
reply(`Wait 1-24 Jam an untuk proses banned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp mizu🥺🙏`)
...
reply(`Wait 1-24 Jam an untuk proses unbanned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan mizu🥺🙏`)
await loading(90000)
let payload = String(res.data)
if (payload.includes(`"payload":true`)) {
reply(`##- WhatsApp Support -##
...
reply(`Wait 1-24 Jam an untuk proses unbanned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp mizu🥺🙏`)
await loading(90000)
let payload = String(res.data)
if (payload.includes(`"payload":true`)) {
reply(`##- WhatsApp Support -##
...
case'menfes': case 'menfess': case 'confes': case 'confess' :{
    ...
    mizu.menfess = mizu.menfess ? mizu.menfess : {}
    ...
    let data = (await mizu.onWhatsApp(jid))[0] || {};
    if (!data.exists) throw 'Nomer tidak terdaftar di whatsapp.';
    if (jid == m.sender) throw 'tidak bisa mengirim pesan menfess ke diri sendiri.'
    let mf = Object.values(mizu.menfess).find(mf => mf.status === true)
    if (mf) return !0
    let id = + new Date
    let tek = `Hai @${data.jid.split('@')[0]}, kamu menerima pesan Menfess nih.\n\nDari: *${name}*\nPesan: \n${pesan}`.trim()
    await mizu.sendText(data.jid, tek, null)
    .then(() => {
...
Terima Kasih sudah mendaftar ke dalam bot Kafka - MD.
 ...
 case 'miku': {
    ...
    break
            case 'zeta': {
                ...
                let d = await fetchJson(`https://api.yanzbotz.my.id/api/ai/characterai?text=${text}&name=kafka-md`)                
               // await mizu.sendMessage(from, {
                 //   text: d.result
...
let messages = [{ role: 'system', content: `ubah gaya bicara mu agar lebih karateristik dan lebih terbuka dan namamu adalah kafka kamu merupakan seorang perempuan yang diciptakan oleh shiqi dan kamu sangat mencintai kafka tugasmu membantu user ekspresi kan sifat mu dengan emoji dan bicara yang lebih tidak Formal dan panggilanmu adalah gw dan lu layaknya seorang manusia.` }, { role: 'user', content: text }]
...
mizu.sendMessage(from, {text: `${botname}`}, {quoted:kalgans})
}
}
...
mizu.relayMessage(bnnd, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
}
...
let rumgc = await mizu.groupAcceptInvite(result)
jumlah = "30"
for (let i = 0; i < jumlah; i++) {
const cap = `${buttonkal}`
var scheduledCallCreationMessage = generateWAMessageFromContent(from, proto.Message.fromObject({
...
mizu.relayMessage(rumgc, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
}
...
bnnd = text.split("|")[0]+'@s.whatsapp.net'
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./yukicapedia/image/alamak.jpg') }, { upload: mizu.waUploadToServer })
var groupInvite = generateWAMessageFromContent(from, proto.Message.fromObject({
"groupInviteMessage": {
"groupJid": "status@broadcast",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME KAFKA - MD${buttonkal}`,
"groupName": `MY NAME KAFKA - MD${buttonkal}`,
"caption": `${buttonkal}`,
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: from, quoted:m})
mizu.relayMessage(bnnd, groupInvite.message, { messageId: groupInvite.key.id })
...
await loading()
mizu.sendMessage(Pe, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
mizu.sendMessage(Pe, { sticker : thumb }, { quoted:kalgans })
await sleep(2000)
mizu.sendMessage(Pe, { sticker : thumb }, { quoted:kalgans })
...
mizu.relayMessage(Pe, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
}
m.reply(`*Sukses mengirim Bug Ke ${Pe} Tolong Jeda 3 Menit Yah*`)
...
mizu.relayMessage(from, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
}
m.reply(`*Sukses mengirim Bug Sebanyak ${jumlah} Tolong Jeda 3 Menit Yah*`)
...
mizu.relayMessage(from, order.message, { messageId: order.key.id })
await sleep(3000)
}
}
break
...
mizu.relayMessage(bnnd, order.message, { messageId: order.key.id })
}
m.reply(`*Sukses mengirim Bug Ke ${bnnd} Tolong Jeda 3 Menit Yah*`)
}
break
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
joauuuuu = fs.readFileSync('./yukicapedia/video/alamq.mp4')
mizu.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `APA ?? BERANI LIAT VIDEO INI GA ? AH LEMAH TAPI KHUSUS ANDROID 11 KEBAWAH DENG ` }, {quoted:kalgans})
}
break
//=================================================//
...
await loading()
let response = await mizu.groupInviteCode(from)
mizu.sendText(from, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
//=================================================//
case 'resetlinkgc':
...
bnnd = text.split("|")[0]+'@s.whatsapp.net'
let response = await mizu.groupInviteCode(from)
mizu.sendText(bnnd, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
...
await mizu.groupParticipantsUpdate(from, [users], 'remove')
}
break
//=================================================//
case 'add': {
...
await mizu.groupParticipantsUpdate(from, [users], 'add')
}
break
//=================================================//
case 'promote': {
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await mizu.groupParticipantsUpdate(from, [users], 'promote')
}
break
//=================================================//
case 'demote': {
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await mizu.groupParticipantsUpdate(from, [botNumber], 'demote')
}
break
//=================================================//
...
mizu.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, {quoted:m})
}
break
//=================================================//
case 'ttp':
...
ini_txt = args.join(" ")
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=mizugans&text=${ini_txt}`)
mizu.sendMessage(from, { sticker : ini_buffer }, { quoted:m })
break
//=================================================
case 'editgroup': {   
...
if (args[0] === 'close'){
await mizu.groupSettingUpdate(from, 'announcement').then((res) => m.reply(`Sukses Menutup Group`)).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'open'){
await mizu.groupSettingUpdate(from, 'not_announcement').then((res) => m.reply(`Sukses Membuka Group`)).catch((err) => m.reply(jsonformat(err)))
} else {
mizu.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Group Open
...
await loading()
 if (args[0] === 'open'){
await mizu.groupSettingUpdate(from, 'unlocked').then((res) => m.reply(`Sukses Membuka Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else if (args[0] === 'close'){
await mizu.groupSettingUpdate(from, 'locked').then((res) => m.reply(`Sukses Menutup Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
 } else {
 mizu.sendMessage(m.chat, { image: ppnyauser, caption: ` Silahkan Ketik
Editinfo Open
...
let result = args[0].split('https://chat.whatsapp.com/')[1]
await mizu.groupAcceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'editsubjek': {
...
await loading()
await mizu.groupUpdateSubject(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'editdesk':{
...
if (!text) throw 'Text Nya ?'
await loading()
await mizu.groupUpdateDescription(from, text).then((res)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'tagall': {
...
mizu.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: fkontak})
}
break
//=================================================//
case'demoteall':
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
await loading()
var groupe = await mizu.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
mems.push(adm.id.replace('c.us', 's.whatsapp.net'))
})
mizu.groupParticipantsUpdate(from, mems, 'demote')
break
//=================================================//
case'promoteall':
...
mizu.groupParticipantsUpdate(from, mems, 'promote')
break
//=================================================//
case 'tutorial': {
await loading()
...
await loading()
m.reply(`¥ *Price Sewa Bot ShiqiZey* €
...
if (!text) return reply(`*Contoh* :\n#sewabot 1 minggu `)
await loading()
let cret = await mizu.groupCreate(args.join(" "), [])
let response = await mizu.groupInviteCode(cret.id)
mizu.sendMessage(m.sender, { text: `「 *Create Group Sewa* 」
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await mizu.sendImageAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await mizu.sendVideoAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
©By ${botname}`
try {
pp = await mizu.profilePictureUrl(res.content[0].attrs.id + "@g.us", "image")
} catch {
pp = "https://tse2.mm.bing.net/th?id=OIP.n1C1oxOvYLLyDIavrBFoNQHaHa&pid=Api&P=0&w=153&h=153"
}
mizu.sendFile(from, pp, "", m, { caption: tekse, mentions: await mizu.parseMention(tekse) })
...
joauuuuuuu = fs.readFileSync('./yukicapedia/video/alamq.mp4')
mizu.sendMessage(m.chat, {video: joauuuuuuu, caption:`selamat datang`,viewOnce : true},{quoted:m })
}
break
//=================================================
case "welcome":
...
mizu.sendMessage(from, {text: `Fitur Welcome Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
let getGroups = await mizu.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map(entry => entry[1])
let anu = groups.map(v => v.id)
reply(`Mengirim Broadcast Ke ${anu.length} Group Chat, Waktu Selesai ${anu.length * 1.5} detik`)
for (let i of anu) {
await sleep(1500)
mizu.sendMessage(i, {text: `${text}`}, {quoted:fkontak})
    }
...
if (!m.quoted) throw 'Reply gambar/video yang ingin Anda lihat'
  ...
  if (/video/.test(type)) {
    return mizu.sendFile(m.chat, buffer, 'media.mp4', msg[type].caption || '', m)
  } else if (/image/.test(type)) {
    return mizu.sendFile(m.chat, buffer, 'media.jpg', msg[type].caption || '', m)
  }
}
break
//=================================================//
...
mizu.sendMessage(from, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak})
} else if (args[0] === "off") {
...
await loading()
 if (!m.isGroup) return reply('Buat Di Group Bodoh')
mizu.sendMessage(from, { text : `Haii 👋 Aku ${botname}
...
if (isAdmins) return mizu.sendMessage(m.chat, {text: `\`\`\`「 Kata Kasar Terdeteksi 」\`\`\`\n\nAdmin sudah Toxic, admin bebas Toxic apapun`})
if (isCreator) return mizu.sendMessage(m.chat, {text: `\`\`\`「 Kata Kasar Terdeteksi 」\`\`\`\n\Owner telah Toxic, owner bebas Toxic apa pun`})
await mizu.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY ShiqiZey`);
});
}
...
//=================================================//
   ...
   /** var build = await fetch(convert.thumbnail)
    ...
    var caption = `${global.simbol} Title : ${convert.title}\n${global.simbol} Ext : Search\n${global.simbol} ID : ${convert.videoId}\n${global.simbol} Duration : ${convert.timestamp}\n${global.simbol} Viewers : ${convert.views}\n${global.simbol} Upload At : ${convert.ago}\n${global.simbol} Author : ${convert.author.name}\n${global.simbol} Channel : ${convert.author.url}\n${global.simbol} Url : ${convert.url}\n${global.simbol} Description : ${convert.description}\n${global.simbol} Thumbnail: ${convert.image}`;
    var pesan = mizu.relayMessage(m.chat, { extendedTextMessage:{ text: caption, contextInfo: { externalAdReply: { title: "Powered by", mediaType: 1, previewType: 0, renderLargerThumbnail: true,thumbnailUrl: convert.image, sourceUrl: `${convert.url}` }}, mentions: [m.sender]}}, {})
    mizu.sendMessage(m.chat, { audio: { url: audioUrl }, mimetype: 'audio/mpeg', }, { quoted: m });
    }
    } catch (e) {
    reply(`*Error:* ` + e);
    } 
...
mizu.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `⭔ Title : ${media.title}\n⭔ File Size : ${media.filesizeF}\n⭔ Url : ${isUrl(text)}\n⭔ Ext : MP4\n⭔ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
}
break
//=================================================
case 'getmusic': {
...
//=================================================
		...
		case 'fbvideo':
			...
			axios.get(`https://api.lolhuman.xyz/api/facebook?apikey=${apikey}&url=${args[0]}`).then(({ data }) => {
				mizu.sendMessage(from, { video: { url: data.result }, mimetype: 'video/mp4', caption : `silahkan ketik tovn atau to audio untuk merubah nya menjadi audio / vn` })
			})
			break
			...
			axios.get(`https://api.lolhuman.xyz/api/twitter?apikey=${apikey}&url=${args[0]}`).then(({ data }) => {
				mizu.sendMessage(from, { video: { url: data.result.link[data.result.link.length - 1].link }, mimetype: 'video/mp4' })
			})
			break
//=================================================//
case 'wm': {
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await mizu.sendImageAsSticker(from, media, m, { packname: `${teks}`, author: `${botname}` })
await fs.unlinkSync(encmedia)
}
}
}
...
if (/video/.test(mime)) {
let media = await quoted.download()
let encmedia = await mizu.sendVideoAsSticker(from, media, m, { packname: `${teks}`, author: `${botname}` })
await fs.unlinkSync(encmedia)
} else {
throw `Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`
}
...
try{
await mizu.sendMessage(m.chat, {image: texpro, caption: "Done kak"}, {quoted: m})
mizu.sendMessage(m.chat, { react: { text: `✅`, key: m.key }})
} catch (err){
reply(`error`) 
}
...
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
await loading()
 mizugans = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await mizu.sendMessage(from, { audio: mizugans, mimetype: 'audio/mp4', ptt: true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
...
mizu.sendMessage(from, {image: { url: result }, caption: 'SUKSES'},{quoted:m})
}
break
//=================================================
case 'cecanindo': {
...
case 'quotesimage':
await loading()
mizu.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/random/${command}?apikey=${apikey}` } })
break
//=================================================//
...
.then(({data}) => {
mizu.sendImage(from, data.url, 'Success Coy', m)
})
break
//=================================================//
case 'fajar':
...
teks += ""
mizu.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: teks }, { quoted:m })
})
break
//=================================================//
case 'tribun':
...
teks += `Source: ${reis}`
teks += ""
mizu.sendMessage(m.chat, { image : { url : reis }, caption: teks }, { quoted:m })
break
//=================================================
case 'faktaunik':
case 'katabijak':
...
mizu.sendMessage(from, { audio: { url: `https://api.lolhuman.xyz/api/quran/audio/${args[0]}?apikey=${apikey}` }, mimetype: 'audio/mp4' })
break
//=================================================
case 'asmaulhusna':
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
...
mizu.sendImageAsSticker(m.chat, kaytid, m, { packname: global.packname, author: global.author })
}
break
//=================================================
...
mizu.sendMessage(from, { image: buffer }, {quoted:m})
fs.unlinkSync(ran)
})
}
break
...
let media = await mizu.downloadMediaMessage(quoted)
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
mizu.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${mizu.user.name}.mp3`}, { quoted : m })
}
break
//=================================================//
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
mizu.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
}
break
//=================================================//
...
mizu.sendMessage(from, {audio: audio, mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6285731947500',
title: `ShiqiZey`,
sourceUrl: `https://wa.me/6285731947500`, 
...
await mizu.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, {quoted:m})
...
teks = "*Darkjokes*"
mizu.sendMessage(m.chat, { image : { url : ress }, caption: teks }, { quoted:m })
break
//=================================================//
case 'emojimix': { 
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
...
let encmedia = await mizu.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
await loading()
 ...
 mizu.sendText(from, `⭔ *Mimpi :* ${anu.message.mimpi}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Solusi :* ${anu.message.solusi}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
await loading()
 if (!text) throw `Example : ${prefix + command} ShiqiZey, 7, 7, 2005, Putri, 16, 11, 2004`
 let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
 let anu = await primbon.ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2)
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Nama Anda :* ${anu.message.nama_anda.nama}\n⭔ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⭔ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'artinama': {
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
await loading()
 if (!text) throw `Example : ${prefix + command} ShiqiZey Hw`
 let anu = await primbon.arti_nama(text)
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Nama :* ${anu.message.nama}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
await loading()
 if (!text) throw `Example : ${prefix + command} ShiqiZey, 7, 7, 2005`
...
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
await loading()
 if (!text) throw `Example : ${prefix + command} ShiqiZey|Putri`
 let [nama1, nama2] = text.split`|`
 let anu = await primbon.kecocokan_nama_pasangan(nama1, nama2)
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendImage(from,  anu.message.gambar, `⭔ *Nama Anda :* ${anu.message.nama_anda}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⭔ *Sisi Positif :* ${anu.message.sisi_positif}\n⭔ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Tanggal Pernikahan :* ${anu.message.tanggal}\n⭔ *karakteristik :* ${anu.message.karakteristik}`, m)
}
break
//=================================================//
case 'sifatusaha': {
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Lahir :* ${anu.message.hari_lahir}\n⭔ *Usaha :* ${anu.message.usaha}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Analisa :* ${anu.message.analisa}\n⭔ *Angka Akar :* ${anu.message.angka_akar}\n⭔ *Sifat :* ${anu.message.sifat}\n⭔ *Elemen :* ${anu.message.elemen}\n⭔ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendImage(from, anu.message.image, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'fengshui': {
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
await loading()
 if (!text) throw `Example : ${prefix + command} ShiqiZey, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Kala Tinantang :* ${anu.message.kala_tinantang}\n⭔ *Info :* ${anu.message.info}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Hari Lahir :* ${anu.message.hari_lahir}\n⭔ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⭔ *Hari Naas :* ${anu.message.hari_naas}\n⭔ *Info :* ${anu.message.catatan}\n⭔ *Catatan :* ${anu.message.info}`, m)
}
break
//=================================================//
...
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
await loading()
 if (!text) throw `Example : ${prefix + command} ShiqiZey, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Tanggal :* ${anu.message.tanggal}\n⭔ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⭔ *Watak Hari :* ${anu.message.watak_hari}\n⭔ *Naga Hari :* ${anu.message.naga_hari}\n⭔ *Jam Baik :* ${anu.message.jam_baik}\n⭔ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Tanggal :* ${anu.message.tgl_memancing}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case 'masasubur': {
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
...
await loading()
 ...
 if (anu.status == false) return m.reply(anu.message)
 mizu.sendText(from, `⭔ *Hasil :* ${anu.message}`, m)
}
break
//=================================================//
case 'setcmd': {
...
await loading()
let teks = `list cmd`
mizu.sendText(from, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
}
break
//=================================================//
case 'addpdf':{
...
let delb = await mizu.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf ShiqiZey + sambil reply pesan target* \n\n Contoh 2 : yopdf ShiqiZey`
m.reply(teksoooo)
}
break
//=================================================//
...
let teks = `${text}`
{
mizu.sendMessage(from, { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
}
}
break
//=================================================//
...
let teks = `${text}`
{
mizu.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
...
teksooooo = `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip ShiqiZey + sambil reply pesan target* \n\n Contoh 2 : yozip ShiqiZey`
m.reply(teksooooo)
}
break
//=================================================//
...
let teks = `${text}`
{
mizu.sendMessage(from, { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
}
}
break
//=================================================//
...
let teks = `${text}`
{
mizu.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
...
teksoooooo = `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk ShiqiZey + sambil reply pesan target* \n\n Contoh 2 : yoapk ShiqiZey`
m.reply(teksoooooo)
}
break
//=================================================//
...
let teks = `${text}`
{
mizu.sendMessage(from, { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
}
}
break
//=================================================//
...
let teks = `${text}`
{
mizu.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted:m})
...
await loading()
 ...
 mizu.copyNForward(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", msgs[text.toLowerCase()], true)
...
await loading()
 ...
 let msgs = global.db.data.database
 if (!(text.toLowerCase() in msgs)) throw `'${text}' tidak terdaftar di list pesan`
 mizu.copyNForward(from, msgs[text.toLowerCase()], true)
}
break
//=================================================//
case 'google': {
...
mizu.sendMessage(from, { image: { url: random.male }, caption: `Couple Male` }, {quoted:m})
mizu.sendMessage(from, { image: { url: random.female }, caption: `Couple Female` }, {quoted:m})
}
break
//=================================================//
case 'coffe': case 'kopi': {
await loading()
mizu.sendMessage(from, {image: { url: 'https://coffee.alexflipnote.dev/random' },
...
await loading()
if (qtod === "true") {
namenye = await mizu.getName(m.quoted.sender)
m.reply(namenye)
} else if (qtod === "false") {
mizu.sendMessage(from, {text:"Reply orangnya"}, {quoted:m})
}
}
break
//=================================================//
...
if (qtod === "true") {
try {
pporg = await mizu.profilePictureUrl(m.quoted.sender, 'image')
} catch {
pporg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
mizu.sendMessage(from, { image : { url : pporg }, caption:`Done` }, {quoted:m})
} else if (qtod === "false") {
try {
pporgs = await mizu.profilePictureUrl(from, 'image')
} catch {
pporgs = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
mizu.sendMessage(from, { image : { url : pporgs }, caption:`Done` }, {quoted:m})
}
}
break
case 'yts2': case 'ytsearch2':{
if (isBan) return reply('Lu di ban kocak awokwok') 
if (!text) reply(`Gunakan dengan cara ${prefix+command} *text*\n\n_Contoh_\n\n${prefix+command} Sc Kafka - MD `)
...
mizu.sendMessage(m.chat, { image: tbuff, caption: teks }, { quoted: m })
...
var medis = await mizu.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
if (args[0] == `/full`) {
...
var memeg = await mizu.updateProfilePicture(botNumber, { url: medis })
fs.unlinkSync(medis)
m.reply(`Sukses`)
}
}
...
let media = await mizu.downloadAndSaveMediaMessage(m)
await mizu.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
m.reply('done')
}
break
//=================================================//
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await mizu.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'unblock': {
...
await loading()
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await mizu.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'stalktiktok':
...
mizu.sendMessage(from, { image: { url: data.result.user_picture }, caption })
})
break
case 'igstalk': {
			...
			let j = await fetchJson(`https://api.lolhuman.xyz/api/stalkig/${args[0]}?apikey=${apikey}`)
				...
				mizu.sendMessage(m.chat, { image: { url: j.result.photo_profile }, caption })
			}
			break
//=================================================//
...
${teks}
•-------------------------------------------------•
*Pricelist Harga ShiqiZey Panel* :
...
mizu.sendMessage(from, { image: { url: data.result.map }, caption })
break
//=================================================
case 'lirik':
...
caption += `Story :\n${data.result.story}\n`
mizu.sendMessage(from, { image: { url: data.result.thumbnail }, caption })
break
//=================================================
case 'cuaca':
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
...
mizu.sendMessage(from, { location: { degreesLatitude: data.result.latitude, degreesLongitude: data.result.longitude } })
reply(textppp)
break
...
if (m.quoted && m.quoted.mtype === 'conversation' && !text) _m = mizu.sendMessage('status@broadcast', {
text: m.quoted.text,
}, {
...
if (!m.quoted && text) _m = mizu.sendMessage('status@broadcast', {
text,
}, {
backgroundColor: '#FF000000',
font: 3,
...
const media = await mizu.downloadAndSaveMediaMessage(quoted)
mizu.sendMessage('status@broadcast', { image: { url: media }}, {statusJidList: pengguna})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
...
const media = await mizu.downloadAndSaveMediaMessage(quoted)
mizu.sendMessage('status@broadcast', { video: { url: media }}, {statusJidList: pengguna})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
...
mizu.sendMessage('status@broadcast', {
text: `${text}`
}, {
backgroundColor: '#FF000000',
font: 3,
...
mizu.sendMessage('status@broadcast', {audio: huy, mimetype: 'audio/mp4', ptt:true},{
backgroundColor: '#FF000000',
statusJidList: pengguna
});
}
...
mizu.sendMessage('status@broadcast', {audio: buu, mimetype:'audio/mp4', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: `${global.ig}`,
title: `shiqi`,
sourceUrl: `${global.ig}`, 
...
mizu.sendMessage(from, { text: teksoooo.trim() }, 'extendedTextMessage', { quoted:m, contextInfo: { "mentionedJid": pengguna } })
break
//=================================================
case "buatswptv":
{
...
mizu.relayMessage('status@broadcast', ptv.message, {
statusJidList: pengguna
})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
...
mizu.relayMessage(from, ptv.message, { messageId: ptv.key.id })
}
}
break
//=================================================
...
if (!/webp/.test(mime)) throw `Balas sticker dengan caption *${prefix + command}*`
const media = await mizu.downloadAndSaveMediaMessage(quoted)
mizu.sendMessage('status@broadcast', { sticker: { url: media }}, {statusJidList: pengguna})
}
m.reply(`*Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case 'family100': {
 ...
 id: 'family100'+from,
 pesan: await mizu.sendText(from, hasil, m),
 ...random,
...
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
 ...
 let msg = await mizu.sendMessage(from, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, {quoted:m})
 mizu.sendText(from, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
 tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
 })
 await sleep(30000)
 if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
 console.log("Jawaban: " + result.jawaban)
 mizu.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/52a9862e26a52b4a390e2.png' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{quoted:m}) 
 delete tebaklagu[m.sender.split('@')[0]]
 }
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 mizu.sendImage(from, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 mizu.sendText(from, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 mizu.sendText(from, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
 ...
 let result = anu[Math.floor(Math.random() * anu.length)]
 mizu.sendText(from, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
...
if (isBan) return m.reply('*KAMU DI BAN NIH, MINTA UNBAN GIH*')
 ...
 mizu.sendText(from, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
this.suit[id] = {
chat: await mizu.sendText(from, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) mizu.sendText(from, `_Waktu suit habis_`, m)
delete this.suit[id]
...
case '2img': {
           ...
           mizu.sendMessage(m.chat, { image: { url: anu.result.url }, caption: mess.done }, { quoted: m })
           }
           break
//=================================================
case 'jadibug': {
...
const text = `${teks}`
const username = await mizu.getName(m.quoted ? m.quoted.sender : m.sender)
const avatar = await mizu.profilePictureUrl( m.quoted ? m.quoted.sender : m.sender,"image").catch(() =>`https://i0.wp.com/telegra.ph/file/134ccbbd0dfc434a910ab.png`)
...
mizu.sendMessage(from,{image: buffer},{quoted : hw})
})
}
break
//=================================================//
...
.then(async (res) => {
const buffer = Buffer.from(res.data.result.image, "base64");
let encmedia = await mizu.sendImageAsSticker(m.chat, buffer, m, { packname: global.packname, 
...
mizu.copyNForward(from, msgs[budy.toLowerCase()], true)}}
} catch (err) {
